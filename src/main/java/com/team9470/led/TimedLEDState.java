...
public class TimedLEDState {
	/** default interval for when don't want to specify */
	...
	public static final TimedLEDState NO_CORAL = new TimedLEDState("NO_CORAL", Double.POSITIVE_INFINITY, Color.YELLOW);
